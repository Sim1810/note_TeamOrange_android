...
final int REQUEST_PERMISSION_CODE = 1000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //from android m , u need to request runtime permission
            ...
            btnRecord.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (recordingActivity.this.checkPermissionFromDevice()) {
                        pathSave = Environment.getExternalStorageState()+"/"
                                + UUID.randomUUID().toString() + "_audio_record.3gp";
                        recordingActivity.this.setupMediaRecorder();
                        try {
    ...
    private boolean checkPermissionFromDevice(){
        int write_exernal_storage_result = ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        int record_audio_result = ContextCompat.checkSelfPermission(this,Manifest.permission.RECORD_AUDIO);
        return write_exernal_storage_result == PackageManager.PERMISSION_GRANTED &&
